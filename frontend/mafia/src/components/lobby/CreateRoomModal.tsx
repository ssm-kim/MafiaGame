...
export const CreateRoomModal = ({ show, onClose, roomData, onRoomDataChange, onCreateRoom }: CreateRoomModalProps) => {
 if (!show) return null;
       ...
       <div className="space-y-4">
         ...
         <div>
           ...
           <input
             ...
             onChange={(e) => onRoomDataChange({...roomData, maxPlayers: parseInt(e.target.value)})}
           />
         </div>
           ...
           <div className="grid grid-cols-3 gap-4">
             <div>
               <input
                 ...
                 onChange={(e) => onRoomDataChange({...roomData, mafia: parseInt(e.target.value)})}
               />
             ...
             <div>
               <input
                 ...
                 onChange={(e) => onRoomDataChange({...roomData, police: parseInt(e.target.value)})}
               />
             ...
             <div>
               <input
                 ...
                 onChange={(e) => onRoomDataChange({...roomData, doctor: parseInt(e.target.value)})}
               />
           ...
           <div className="grid grid-cols-3 gap-4">
             <div>
               <input
                 ...
                 onChange={(e) => onRoomDataChange({...roomData, dayTime: parseInt(e.target.value)})}
               />
             ...
             <div>
               <input
                 ...
                 onChange={(e) => onRoomDataChange({...roomData, nightTime: parseInt(e.target.value)})}
               />
             ...
             <div>
               <input
                 ...
                 onChange={(e) => onRoomDataChange({...roomData, voteTime: parseInt(e.target.value)})}
               />
