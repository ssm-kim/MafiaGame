            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                <input
                  type="number"
                  className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-gray-100"
                  value={roomData.gameOption.mafia}
                  onChange={(e) =>
                    onRoomDataChange({
                      ...roomData,
                      gameOption: {
                        ...roomData.gameOption,
                        mafia: parseInt(e.target.value),
                      },
                    })
                  }
                />
              ...
              <div>
                <input
                  type="number"
                  className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-gray-100"
                  value={roomData.gameOption.police}
                  onChange={(e) =>
                    onRoomDataChange({
                      ...roomData,
                      gameOption: {
                        ...roomData.gameOption,
                        police: parseInt(e.target.value),
                      },
                    })
                  }
                />
              ...
              <div>
                <input
                  type="number"
                  className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-gray-100"
                  value={roomData.gameOption.doctor}
                  onChange={(e) =>
                    onRoomDataChange({
                      ...roomData,
                      gameOption: {
                        ...roomData.gameOption,
                        doctor: parseInt(e.target.value),
                      },
                    })
                  }
                />
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                <input
                  type="number"
                  className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-gray-100"
                  value={roomData.gameOption.dayTime}
                  onChange={(e) =>
                    onRoomDataChange({
                      ...roomData,
                      gameOption: {
                        ...roomData.gameOption,
                        dayTime: parseInt(e.target.value),
                      },
                    })
                  }
                />
              ...
              <div>
                <input
                  type="number"
                  className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-gray-100"
                  value={roomData.gameOption.nightTime}
                  onChange={(e) =>
                    onRoomDataChange({
                      ...roomData,
                      gameOption: {
                        ...roomData.gameOption,
                        nightTime: parseInt(e.target.value),
                      },
                    })
                  }
                />
              ...
              <div>
                <input
                  type="number"
                  className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-gray-100"
                  value={roomData.gameOption.voteTime}
                  onChange={(e) =>
                    onRoomDataChange({
                      ...roomData,
                      gameOption: {
